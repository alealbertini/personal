...
int tareas_A[CANT_ZOMBIS];      // para saber que tareas no estan ejecutando
int tareas_B[CANT_ZOMBIS];      // para saber que tareas no estan ejecutando
void tss_inicializar_zombie(int jugador, unsigned int cr3);
void zombie_en_uso();
#endif  /* !__TSS_H__ */
